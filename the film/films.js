...
const container = document.getElementById("films-row")
// console.table(films)
const array = films.results
array.forEach((el) =>{
    container.innerHTML += `
        <div class="col-sm-3 mb-3">
            <div class="card">
                <img src="https://www.themoviedb.org/t/p/w600_and_h900_bestv2/${el.backdrop_path}" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">${el.original_title}</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
                        content.</p>
                    <button onclick=showModal(${el.id}) class="btn btn-primary">Go somewhere</button>
                </div>
            </div>
        </div>
    `
    ...
    container.innerHTML = `
        <div class="col-sm-8 mb-3">
            <div class="card mb-3">
                <div class="row g-0">
                <div class="col-md-4">
                    <img src="https://www.themoviedb.org/t/p/w600_and_h900_bestv2/${el.backdrop_path}" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                    <h5 class="card-title">${el.original_title}</h5>
                    <p class="card-text">${el.overview}</p>
                    <p class="card-text"><small class="text-body-secondary">Released ${el.release_date}</small></p>
